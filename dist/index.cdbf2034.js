!function(t, e) {
    "object" == typeof exports && "object" == typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define([], e) : "object" == typeof exports ? exports._vantaEffect = e() : t._vantaEffect = e();
        ...
        class l extends a {
            ...
            onInit() {
                let t, e;
                const s = this.getMaterial(), o = new p.BufferGeometry;
                this.gg = [];
                const n = [];
                for(t = 0; t <= this.ww; t++)for(this.gg[t] = [], e = 0; e <= this.hh; e++){
                    const i = n.length, s = new p.Vector3(18 * (t - .5 * this.ww), (r = 0, null == (h = this.waveNoise) && (h = 1), r + Math.random() * (h - r) - 10), 18 * (.5 * this.hh - e));
                ...
                for(t = 1; t <= this.ww; t++)for(e = 1; e <= this.hh; e++){
                    let s, o;
                    const n = this.gg[t][e], r = this.gg[t][e - 1], h = this.gg[t - 1][e], p = this.gg[t - 1][e - 1];
                    i(0, 1) ? (s = [
                        p,
                        r,
                        h
            ...
            onUpdate() {
                ...
                for(let t = 0; t < this.plane.geometry.attributes.position.array.length; t += 3){
                    ...
                    if (e.oy) {
                        const i = this.options.waveSpeed, s = Math.sqrt(i) * Math.cos(-e.x - .7 * e.z), o = Math.sin(i * this.t * .02 - i * e.x * .025 + i * e.z * .015 + s), n = Math.pow(o + 1, 2) / 4;
...
//# sourceMappingURL=index.cdbf2034.js.map
